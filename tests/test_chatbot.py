...
from src.Langchain-Documentation-AIChatBot.core.chatbot import LangChainChatbot
from src.Langchain-Documentation-AIChatBot.utils.config import config
...
class TestLangChainChatbot:
    ...
    def mock_config(self):
        ...
        with patch('src.Langchain-Documentation-AIChatBot.core.chatbot.config') as mock_config:
    ...
    def chatbot(self, mock_config):
        ...
        with patch('src.Langchain-Documentation-AIChatBot.core.chatbot.ChatOpenAI'):
            with patch('src.Langchain-Documentation-AIChatBot.core.chatbot.ConversationBufferMemory'):
...
class TestDocumentLoader:
    ...
    def test_clean_text(self):
        ...
        from src.Langchain-Documentation-AIChatBot.utils.helpers import clean_text
    ...
    def test_chunk_text(self):
        ...
        from src.Langchain-Documentation-AIChatBot.utils.helpers import chunk_text
...
class TestVectorStore:
    ...
    def test_vector_store_initialization(self):
        ...
        from src.Langchain-Documentation-AIChatBot.core.vector_store import VectorStore
        
        with patch('src.Langchain-Documentation-AIChatBot.core.vector_store.config') as mock_config:
...
class TestConfig:
    ...
    def test_config_initialization(self):
        ...
        with patch('src.Langchain-Documentation-AIChatBot.utils.config.load_dotenv'):
            config = Config()
